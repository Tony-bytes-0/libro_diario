        ...
        <v-form class="d-flex" @submit.prevent="submit">
            <v-row class="pt-6 px-5 align-center ma-1">
                ...
                <v-col cols="6">
                    ...
                    <v-autocomplete variant="outlined" autocomplete="off" :items="clientsList" item-title="descripcion"
                        item-value="id" return-object v-model="formData.client" :rules="[rules.required('Este campo es requerido')]"></v-autocomplete>
                </v-col>
                <v-col cols="3">
                    <v-label>RIF</v-label>
